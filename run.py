...
SPELL_API_KEY = api_key.SPELL_API_KEY
SPELL_params = {
    'mkt': 'en-us',
    'mode': 'proof'
}
...
def prediction():
    ...
    AFL.count += 1
    results = {'sentence': result_conv, 'similarity': result_mrpc, 'correct': result_cola, 'contents': chatbot.contents,
               'count': AFL.count, 'spell': result_spell if result_spell != [] else ['good job'], 'isChanged': AFL.changed_flag}
